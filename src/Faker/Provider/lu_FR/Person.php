...
class Person extends \Faker\Provider\Person
{
    protected static $firstNameMale = array(
        ...
        'Guy','Hadji','Henri','Ilham','Jean-Michel','Jean-Paul','Jeff','Jo','Joao','Joël','John','Julien','Laurent','Lex','Luc',
    ...
    protected static $firstNameFemale = array(
        ...
        'Catarina','Catherine','Catia','Cécile','Céline','Chantal','Charlotte','Christelle','Christiane','Christine',
        'Cindy','Claire','Claudia','Danielle','Déborah','Delphine','Diana','Diane','Dorothé-Maria','Elena','Eliane',
        'Erika','Ernestine','Esmeralda','Eva','EVITA','Fabiana','Fabienne','Fabrice','Fanny','Fany','Farida','Fatima',
        'Fernanda','Gérardina','Germana','Ginette','Gnad','Harpa','Helen','Helena','Hélène','Heloise','Ina','Ingrid',
        'Ioannis','Iris','Jean-Marie','Jennifer','Jessica','Jessy','Joana','Joelle','Joëlle','Johanna','Josiane','Julie',
        'Karin','Karine','Laurence','Léa','Lénaïck','Léonie','Liliane','Lily','Linda','Lisa','Margret','Maria',
        'Marianne','Marie','Marie-Paule','Marie-Rose','Marina','Marine','Marion','Martijn','Martina','Martine','Martinez',
        'Maryse','Maurice','Maxime','Mélanie','Mélissa','Merryl','Muriel','Myriam','Nadia','Nadine','Nancy','Natalia',
        'Nathalie','Nicole','Nora','Odette','Pascale','Pouss','Rachel','Raffaele','Renée','Rita','Roberta','Rosa',
